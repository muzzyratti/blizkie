...
async def cmd_start(message: types.Message):
    ...
    if filters:
        ...
        time_label = TIME_MAP.get(filters.get("time_required"),
                                  filters.get("time_required", "не указано"))
        energy_label = ENERGY_MAP.get(filters.get("energy"),
                                      filters.get("energy", "не указана"))
        location_label = location_MAP.get(
            filters.get("location"), filters.get("location", "не указано"))
        ...
        keyboard = InlineKeyboardMarkup(
            inline_keyboard=[[
                InlineKeyboardButton(text="🔄 Хочу новые фильтры",
        ...
        # Стартовое приветствие, если пользователь запускает впервые
