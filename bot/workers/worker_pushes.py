    ...
    # ================================
        ...
        try:
            text = (
                ...
                "Вижу, что ты несколько раз пользовался ботом — для меня это хороший знак, что возможно бот помог вам с ребëнком сблизиться!\n\n"
                "Хочу попросить тебя о небольшой помощи в развитии этого проекта.\n\n"
                "Давай пообщаемся 10–15 минут? Хочу услышать, что тебе нравится в боте, "
                "а что можно ещё улучшить.\n\n"
                "Если ок — нажми кнопку ниже и просто напиши мне в любое время 🙌. Я сразу отвечу как смогу."
            )
